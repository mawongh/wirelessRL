...
def main():
	...
	outputfile = 'model-based_history.csv'
	...
	model_weigths = 'Q_model_DP_g05_weights.h5'
	agent.load_weights(model_weigths)

	scaler = StandardScaler()
	scaler.mean_ = np.loadtxt('s_model-based_mean_.csv', delimiter=',')
	scaler.scale_ = np.loadtxt('s_model-based_scale_.csv', delimiter=',')
